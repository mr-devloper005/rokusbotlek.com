...
export default function AboutPage() {
  return (
    <EditableSiteShell>
      <main className="bg-[var(--editable-page-bg,#f3f7fb)] px-4 py-14 text-[var(--editable-page-text,#07152e)] sm:px-6 lg:px-8">
        <section className="mx-auto grid max-w-[var(--editable-container)] gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <article className="rounded-lg border border-[var(--editable-border)] bg-white p-8 shadow-sm lg:p-12">
            ...
            <h1 className="mt-5 text-4xl font-black leading-tight tracking-[-0.05em] sm:text-5xl">About {globalContent.site.name}</h1>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              {['Business profiles', 'Category discovery', 'Direct contact'].map((item) => (
                <div key={item} className="rounded-lg bg-[#eaf2ff] px-4 py-3 text-sm font-black text-[#2563c8]">{item}</div>
              ))}
            </div>
          </article>
