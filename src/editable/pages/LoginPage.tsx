...
export default function LoginPage() {
  return (
    <EditableSiteShell>
      <main className="bg-[var(--editable-page-bg,#f3f7fb)] text-[var(--editable-page-text,#07152e)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          ...
          <div className="rounded-lg border border-[var(--editable-border)] bg-white p-6 shadow-[0_24px_70px_rgba(15,39,71,0.10)] backdrop-blur sm:p-8">
